...
final class AsyncImageViewModelHack: ObservableObject {
    ...
    init(
        ...
        Publishers.system(
            ...
            feedbacks: [
                Self.whenIdle(url: url, dataProvider: dataProvider),
...
extension AsyncImageViewModelHack {
